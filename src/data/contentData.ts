...
export const videos: Video[] = [
  {
    id: '1',
    title: 'SAP Datasphere: The Future of Data Management',
    description: 'Comprehensive overview of SAP Datasphere capabilities and how it transforms enterprise data management with unified data fabric.',
    ...
    tags: ['SAP Datasphere', 'Data Management', 'Enterprise Data'],
    platform: 'youtube'
  },
  {
    id: '2',
    title: 'SAP AI Core: Enterprise AI Platform Overview',
    description: 'Deep dive into SAP AI Core platform and how to build, deploy, and manage AI models at enterprise scale.',
    ...
    tags: ['SAP AI Core', 'Machine Learning', 'Enterprise AI'],
    platform: 'youtube'
  },
  {
    id: '3',
    title: 'SAP Analytics Cloud: Business Intelligence Reimagined',
    description: 'Explore how SAP Analytics Cloud transforms business intelligence with embedded AI and collaborative planning capabilities.',
    ...
    tags: ['SAP Analytics Cloud', 'Business Intelligence', 'Predictive Analytics'],
    platform: 'youtube'
  },
  {
    id: '4',
    title: 'SAP Build: Low-Code Development Platform',
    description: 'Learn how SAP Build enables rapid application development with low-code/no-code capabilities for citizen developers.',
    ...
    tags: ['SAP Build', 'Low-Code', 'Application Development'],
    platform: 'youtube'
  },
  {
    id: '5',
    title: 'SAP Business Technology Platform Overview',
    description: 'Complete introduction to SAP BTP and how it serves as the foundation for digital transformation initiatives.',
  ...
  {
    id: '6',
    title: 'Joule AI Copilot: The Future of Work',
    description: 'Discover how SAP Joule AI copilot is transforming business processes with intelligent automation and natural language interaction.',
    videoUrl: 'https://www.youtube.com/watch?v=jNQXAC9IVRw',
    thumbnailUrl: 'https://images.pexels.com/photos/3184287/pexels-photo-3184287.jpeg?auto=compress&cs=tinysrgb&w=800',
    duration: '13:40',
    category: 'ai-ml',
    addedAt: new Date('2024-01-09'),
    tags: ['Joule AI', 'AI Copilot', 'Intelligent Automation'],
    platform: 'youtube'
  }
];